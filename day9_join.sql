...
------------------------------------------------------------------------------*/
    SELECT s.sýrket_isim, sp.siparis_id, sp.siparis_tarihi, sp.sirket_id
    FROM sirketler s
    FULL JOIN siparisler sp 
    ON sp.sirket_id = s.sirket_ýd;
...
------------------------------------------------------------------------------*/ 
    ...
    ON sp.sirket_id = s.sirket_ýd;  --ortak olan ID LERI gosterdý ýnner ýle býrlýkte
...
------------------------------------------------------------------------------*/
    ...
    SELECT s.sýrket_isim, sp.siparis_id, sp.siparis_tarihi, sp.sirket_id, s.sirket_ýd
    FROM sirketler s
